...
export const translations = {
  en: {
    ...
    vision: {
      ...
      desc2: "We are here to solve the daily struggles of local shopkeepers, service providers, distributors, family businesses, and growing startups — in the simplest way possible.",
    ...
    founder: {
      ...
      p1: "We started Ansh Apps to solve a simple problem: small businesses are neglected by modern tech.",
      ...
      p4: "Ansh Apps is our promise to growing businesses.",
    ...
    cta: {
      ...
      title4: "Every Business 🌍",
      desc: "Join thousands of businesses simplifying their daily work.",
  ...
  hi: {
    ...
    vision: {
      ...
      desc2: "हम दुकानदार, सर्विस प्रोवाइडर, डिस्ट्रीब्यूटर, परिवारिक व्यवसायों और बढ़ते स्टार्टअप्स के लिए बेहद आसान और व्यावहारिक टूल्स बना रहे हैं जो उनके काम को सरल बनाएं।",
    ...
    cta: {
      ...
      title2: "आगे बढ़ाएं 🇮🇳",
      title3: "सरल तकनीक",
      title4: "हर व्यवसाय के लिए 🌍",
      desc: "हजारों व्यवसाय पहले ही अंश के साथ अपने काम को आसान बना रहे हैं।",
      namaskaram: "नमस्कार 🙏",
